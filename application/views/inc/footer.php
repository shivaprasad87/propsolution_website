      ...
      <div class="col-sm-4 text-center">
        <div class="info-box">
          ...
          <ul class="text-center">
            ...
            <li><a href="#.">info@something.com</a></li>
          </ul>
        </div>
      </div>
    </div>
        ...
        <div class="footer_panel bottom30">
          ...
          <div class="media bottom30">
            <div class="media-body">
              ...
              <span><i class="icon-clock5"></i>Feb 22, 2020</span>
            </div>
          </div>
          <div class="media">
            <div class="media-body">
    ...
    <div class="copyright_simple">
      <div class="row">
        <div class="col-md-6 col-sm-5 top20 bottom20">
          <p>Copyright &copy; 2020 <span>Test</span>. All rights reserved.</p>
        </div>
...
<script src="<?=base_url('assets/');?>js/range-Slider.min.js"></script>
<script src="<?=base_url('assets/');?>js/owl.carousel.min.js"></script> 
<script src="<?=base_url('assets/');?>js/selectbox-0.2.min.js"></script>
