...
<!--                             <div class="">
                   ...
                   <!-- <div class="col-sm-6 col-md-6 col-lg-6">
                        <div class="form-group">
                            <label class="control-label" for="exampleInputFile">desktop_banner_1<code>*</code></label>
                            <div class=" <?= form_error('uploadImage') ? 'has-error' : '' ?>">
                                <input type="file" class="form-control" name="desktop_banner_1">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        <div class="form-group">
                            <label class="control-label" for="exampleInputFile">mobile_banner_1<code>*</code></label>
                            <div class=" <?= form_error('uploadImage') ? 'has-error' : '' ?>">
                                <input type="file" class="form-control" name="mobile_banner_1">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        <div class="form-group">
                            <label class="control-label" for="exampleInputFile">desktop_banner_2</label>
                            <div class=" <?= form_error('uploadImage') ? 'has-error' : '' ?>">
                                <input type="file" class="form-control" name="desktop_banner_2">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        <div class="form-group">
                            <label class="control-label" for="exampleInputFile">mobile_banner_2</label>
                            <div class=" <?= form_error('uploadImage') ? 'has-error' : '' ?>">
                                <input type="file" class="form-control" name="mobile_banner_2">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        <div class="form-group">
                            <label class="control-label" for="exampleInputFile">desktop_banner_3</label>
                            <div class=" <?= form_error('uploadImage') ? 'has-error' : '' ?>">
                                <input type="file" class="form-control" name="desktop_banner_3">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        <div class="form-group">
                            <label class="control-label" for="exampleInputFile">mobile_banner_3</label>
                            <div class=" <?= form_error('uploadImage') ? 'has-error' : '' ?>">
                    ...
                    <div class="col-sm-2 col-md-2 col-lg-2">
                        <div class="form-group">
                            ...
                            <div class=" <?= form_error('floors') ? 'has-error' : '' ?>">
                                ...
                                placeholder="No of Floors" value="<?= set_value('floors') ? set_value('floors') : '0' ?>">
                    ...
                    <div class="col-sm-2 col-md-2 col-lg-2">
                        <div class="form-group">
                            ...
                            <div class=" <?= form_error('towers') ? 'has-error' : '' ?>">
                                ...
                                placeholder="No of Towers" value="<?= set_value('towers') ? set_value('towers') : '0' ?>">
                    ...
                    <div class="col-sm-2 col-md-2 col-lg-2">
                        <div class="form-group">
                            ...
                            <div class=" <?= form_error('units') ? 'has-error' : '' ?>">
                                ...
                                placeholder="No of Units" value="<?= set_value('units') ? set_value('units') : '0' ?>">
